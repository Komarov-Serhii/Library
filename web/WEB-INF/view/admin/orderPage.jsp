    ...
    <header id="header" class="header-area">
        ...
        <div class="logoBlock">
            <div style="font-size: 16px; text-align: end;">
                ...
                <a class="loginBtn"
                   href="${pageContext.request.contextPath}/view/language/admin/orderPage?language=RU">RU</a>
                <a class="loginBtn"
                   href="${pageContext.request.contextPath}/view/language/admin/orderPage?language=EN">EN</a>
            </div>
