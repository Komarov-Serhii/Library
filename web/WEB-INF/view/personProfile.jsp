...
<%--                </a>--%>
<%--                <a class="btn"--%>
<%--                   href="${pageContext.request.contextPath}/view/language/personProfile?language=RU">--%>
<%--                    RU--%>
<%--                </a>--%>
<%--                <a class="btn"--%>
<%--                   href="${pageContext.request.contextPath}/view/language/personProfile?language=EN">--%>
<%--                    EN--%>
<%--                </a>--%>
<%--            </div>--%>
