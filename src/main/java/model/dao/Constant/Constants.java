...
public final class Constants {
    ...
    public static final String UPDATE_BOOK = "UPDATE BOOK SET NAME = ?, AUTHOR = ?, PUBLISHER = ?, PUBLISHER_DATE = ?, DESCRIPTION = ?, PRICE = ?, GENRE = ?, STATUS = ?, person_id = ?, order_status = ? WHERE ID = ?";
    public static final String UPDATE_BOOK_PHOTO = "UPDATE BOOK_PHOTO SET  URL = ?, book_id = ? WHERE ID = ?";
    public static final String UPDATE_CONTRACT = "UPDATE contract SET  person_id = ?, book_id = ? WHERE ID = ?";
   ...
   // public static final String ALL_BOOK = "SELECT * FROM book WHERE status = 1 and новая колонка = 2 ";
    ...
    public static final String ALL_PERSON_2 = "SELECT  * FROM person WHERE  level = '2'";
    ...
    public static final String SELECT_BY_ID_CONTRACT = "SELECT * FROM order WHERE id = ?";
    ...
    public static final String INSERT_BOOK = "INSERT INTO BOOK (name, author, publisher, publisher_date, description, price, genre, status, person_id, order_status) VALUES (?,?,?,?,?,?,?,?,?,?)";
    public static final String INSERT_BOOK_PHOTO = "INSERT INTO BOOK_PHOTO (url, book_id) VALUES (?,?)";
    public static final String INSERT_CONTRACT = "INSERT INTO contract (person_id, book_id) VALUES (?,?)";
